...
const Page = () => {
  ...
  const metaTitle = `Strak ${serviceName.toLowerCase()} in ${city} | NexStuc latexspuit specialist`;
  const metaDescription = `Professioneel ${serviceName.toLowerCase()} in ${city} door NexStuc. Strakke egale wanden, snelle oplevering en garantie. Vraag een vrijblijvende offerte aan in ${city}.`;
