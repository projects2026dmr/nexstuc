...
const Page = () => {
  ...
  const metaTitle = `Complete ${serviceName.toLowerCase()} in ${city} | NexStuc badkamer specialist`;
  const metaDescription = `Professionele ${serviceName.toLowerCase()} in ${city} door NexStuc. Complete renovaties, strak tegelwerk, moderne afwerking en garantie. Vraag een vrijblijvende offerte aan in ${city}.`;
