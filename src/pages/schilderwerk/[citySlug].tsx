...
const Page = () => {
  ...
  const metaTitle = `Professioneel ${serviceName.toLowerCase()} in ${city} | NexStuc schilder specialist`;
  const metaDescription = `Vakkundig ${serviceName.toLowerCase()} in ${city} door NexStuc. Strakke afwerking, duurzame verf en garantie. Vraag een vrijblijvende offerte aan in ${city}.`;
