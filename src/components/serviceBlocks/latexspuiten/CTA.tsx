...
const CTA = ({ serviceName, city }: { serviceName: string; city: string }) => {
  return (
    <div className="bg-gradient-to-br from-brand-950 via-brand-900 to-dark-900 rounded-2xl p-8 sm:p-12 text-center">
      ...
      <p className="text-white/70 leading-relaxed max-w-xl mx-auto mb-8">Neem vandaag nog contact op voor een vrijblijvende offerte voor {serviceName.toLowerCase()} in {city}. Onze spuitteams staan voor u klaar.</p>
