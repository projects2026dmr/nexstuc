  ...
  return (
    <div className="bg-gradient-to-br from-brand-950 via-brand-900 to-dark-900 rounded-2xl p-8 sm:p-12 text-center">
      ...
      <p className="text-white/70 leading-relaxed max-w-xl mx-auto mb-8">
        NexStuc levert streeploos, egaal en professioneel latexspuitwerk voor woningen en bedrijfspanden.
        Vraag een vrijblijvende offerte aan voor uw project in {city}.
      </p>

      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <button class="bg-brand-500 hover:bg-brand-600 text-white text-sm font-semibold px-6 py-2.5 rounded-lg transition-colors duration-200 border-none cursor-pointer">Offerte aanvragen</button>
      ...
      <p className="mt-6 text-white/40 text-sm">
        Binnen 24 uur reactie • Gratis & vrijblijvend • Specialist in latexspuiten
      </p>
    </div>
  );
};
