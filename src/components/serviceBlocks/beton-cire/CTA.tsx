  ...
  return (
    <div className="bg-gradient-to-br from-brand-950 via-brand-900 to-dark-900 rounded-2xl p-8 sm:p-12 text-center">
      ...
      <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
        Klaar voor luxe {serviceName.toLowerCase()} in {city}?
      </h2>

      <p className="text-white/70 leading-relaxed max-w-xl mx-auto mb-8">
        NexStuc is specialist in naadloos, waterdicht en duurzaam beton ciré.
        Vraag een vrijblijvende offerte aan voor uw project in {city} en ontvang
        professioneel advies over kleur, afwerking en toepassing.
      </p>
      ...
      <p className="mt-6 text-white/40 text-sm">
        Binnen 24 uur reactie • Gratis & vrijblijvend • Specialist in beton ciré
      </p>
    </div>
  );
};
